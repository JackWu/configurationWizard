...
import com.xss.objects.PortalStatObject;
import com.xss.service.ConfigurationService;
import com.xss.service.PropertiesServices;
...
public class GreetingController {
    ...
    public @ResponseBody
    Map<String, String> getProperties(@RequestBody Map<String, Object> requestDate){
    ...
    public @ResponseBody
    Map<String, String> updateProperties(@RequestBody Map<String, Object> requestData){
